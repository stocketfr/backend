export const enCatalog = {
  ...
  'tasks.cancelCheckFailed': 'Background task cancellation check failed.',
  'tasks.handlerNotFound': 'Task handler not found.',
  'tasks.heartbeatFailed': 'Background task heartbeat failed.',
  'tasks.leaseLost': 'Background task lease was lost.',
  'tasks.notFound': 'Task not found.',
  'tasks.payloadInvalid': 'Task payload is invalid.',
  'tasks.progressFailed': 'Background task progress update failed.',
  'tasks.recoveryFailed': 'Background task lease recovery failed.',
  'tasks.repositoryFailed': 'Background task operation failed.',
  'tasks.terminalConflict': 'Task is already terminal.',
  'tasks.workerFailed': 'Background task worker failed.',
